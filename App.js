...
/////////
import KingsChroniclesOrigenProdactScreen from './AppScreen/KingsChroniclesOrigenProdactScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://impressive-distinguished-win.space/`;
  const URL_IDENTIFAIRE = `KNfp9ZyQ`;
  ...
  OneSignal.initialize('975ffde3-48ad-4c6f-9c64-94fb9f03a5fa');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-02-07T10:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="KingsChroniclesOrigenProdactScreen"
            component={KingsChroniclesOrigenProdactScreen}
